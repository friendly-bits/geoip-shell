...
5) Supported IP list sources:
	- geoip-shell currently supports following sources: RIPE, ipdeny, MaxMind, IPinfo.
	- RIPE and ipdeny sources are free-to-use and require no license. Maxmind and IPinfo require a license and offer free and paid databases.
	...
	- MaxMind and IPinfo manage proprietary geoip databases which typically provides more accurate data than RIPE and ipdeny, both in the paid and in the free versions. Note that in order to use these source, you need to have an account with the respective provider (MaxMind or IPinfo).
